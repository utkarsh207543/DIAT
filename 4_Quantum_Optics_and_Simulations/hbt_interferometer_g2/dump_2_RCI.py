...
# Parameters
# ----------------------------
filename = "Utkarsh_QRNG_10.txt"  # Replace with your actual text file
bin_width = 1e-8# 10 ns
max_delay = 1e-6  # ±1 µs

# ----------------------------
# Read Ch1 and Ch2 from TXT file
# ----------------------------
def read_channel_timestamps_txt(filename):
    ch1 = []
    ch2 = []
...
ch1_timestamps, ch2_timestamps = read_channel_timestamps_txt(filename)
...
# ----------------------------
# Fast g²(Δt) via FFT-like correlation
# ----------------------------
...
print("📋 All Ch1 timestamps:\n", ch1_timestamps)
print("📋 All Ch2 timestamps:\n", ch2_timestamps)
