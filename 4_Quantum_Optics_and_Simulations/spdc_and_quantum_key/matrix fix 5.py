...
# Function to calculate energy levels (in Joules)
...
num_states_range = np.arange(5, 51, 5)  # Test from 5 to 50 states in steps of 5
tm_te_ratios = []
...
for num_states in num_states_range:
    ...
    prob_sigma_minus = count_sigma_minus / (count_sigma_minus + count_sigma_plus)
    prob_sigma_plus = count_sigma_plus / (count_sigma_minus + count_sigma_plus)

    # Compute TM:TE ratio
    tm_te_ratio = prob_sigma_plus / prob_sigma_minus
