...
# GUI Popup for File Selection
root = tk.Tk()
root.withdraw()  # Hide root window
file_path = filedialog.askopenfilename(title="Select the Time Data CSV File",
...
raw_output_bin = os.path.join(output_dir, "qrng_output_raw.bin")
raw_output_txt = os.path.join(output_dir, "qrng_output_raw.txt")
post_output_bin = os.path.join(output_dir, "qrng_output_post.bin")
post_output_txt = os.path.join(output_dir, "qrng_output_post.txt")
...
print(f"Raw QRNG binary file saved at: {raw_output_bin}")
print(f"Raw QRNG text file saved at: {raw_output_txt}")
...
print(f"Processed QRNG binary file saved at: {post_output_bin}")
print(f"Processed QRNG text file saved at: {post_output_txt}")
