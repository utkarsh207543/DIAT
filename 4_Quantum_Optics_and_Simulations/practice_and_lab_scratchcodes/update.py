...
# Calculate the average particle size in nanometers
average_particle_size_nm = np.mean(particle_sizes) * 0.1  # Convert from Ångstroms to nanometers

# Annotate the graph with the average particle size in nanometers
plt.annotate(f'Average Particle Size: {average_particle_size_nm:.2f} nm',
