#!/usr/bin/env python3
"""
QRNG Post-Processing Suite - Fixed Encoding and Overflow Issues
Updated with proper encoding handling and safe integer operations.
"""
...
class QRNGPostProcessingSuite:
    ...
    def process_qrng_pipeline(self):
        ...
        print("\n" + "="*60)
        print("STEP 2: Von Neumann Debiasing (Base Processing)")
        print("="*60)
        ...
        techniques = [
            ...
            ("LeftoverHashLemma", lambda x: self.leftover_hash.extract_fast(x, self.target_bits // 10)),
        ...
        for idx, (name, technique_func) in enumerate(techniques, 1):
            ...
            try:
                ...
                if len(amplified_bits) < self.target_bits:
                    print(f"   {name}: Only generated {len(amplified_bits):,} bits")
                else:
                    # Ensure exact target
                ...
                print(f"   {name} completed in {technique_time:.2f} seconds")
    ...
    def _save_raw_data(self, raw_bits: str):
        ...
        print(f"Raw data balance: {analysis['balance']:.6f}")
    ...
    def _save_debiased_base(self, debiased_bits: str):
        ...
        print(f"Debiased balance: {analysis['balance']:.6f}")
    ...
    def _save_final_result(self, technique_name: str, bits: str):
        ...
        print(f"   Balance: {analysis['balance']:.6f}")
