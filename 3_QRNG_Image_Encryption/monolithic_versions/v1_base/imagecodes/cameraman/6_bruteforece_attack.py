...
OUT_DIR = os.path.join(BASE, "results_6")
...
def brute_force_time_estimate_log(key_bits, trials_per_second=1e12):
    """
    Returns log10(time in seconds) and log10(time in years)
    """
    log10_keys = key_bits * math.log10(2)
    log10_rate = math.log10(trials_per_second)

    log10_seconds = log10_keys - log10_rate
